...
Copy\+Policy\+: Released under the terms of the GNU GPL v2.\+0.\hypertarget{group__src__demoYoga_intro_sec}{}\doxysubsubsection{\texorpdfstring{Description}{Description}}\label{group__src__demoYoga_intro_sec}
...
Finally, a simulation modality is available to run the demo within gazebo.\hypertarget{group__src__demoYoga_lib_sec}{}\doxysubsubsection{\texorpdfstring{Libraries}{Libraries}}\label{group__src__demoYoga_lib_sec}

\begin{DoxyItemize}
\item ctrl\+Lib.
\item i\+Kin.
\item YARP libraries.
\end{DoxyItemize}\hypertarget{group__src__demoYoga_parameters_sec}{}\doxysubsubsection{\texorpdfstring{Parameters}{Parameters}}\label{group__src__demoYoga_parameters_sec}
None.\hypertarget{group__src__demoYoga_portsa_sec}{}\doxysubsubsection{\texorpdfstring{Ports Accessed}{Ports Accessed}}\label{group__src__demoYoga_portsa_sec}
...
In order to run the demo in simulation, such modules can be run with {\ttfamily -\/-\/context gazebo\+Cartesian\+Control}. A template is also available in the folder app/scripts/demo\+Red\+Ball\+\_\+gazebo.\+xml.\+template.\hypertarget{group__src__demoYoga_portsc_sec}{}\doxysubsubsection{\texorpdfstring{Ports Created}{Ports Created}}\label{group__src__demoYoga_portsc_sec}
...
\end{DoxyItemize}\hypertarget{group__icub__pf3dTracker_in_files_sec}{}\doxysubsubsection{\texorpdfstring{Input Data Files}{Input Data Files}}\label{group__icub__pf3dTracker_in_files_sec}
None.\hypertarget{group__icub__pf3dTracker_out_data_sec}{}\doxysubsubsection{\texorpdfstring{Output Data Files}{Output Data Files}}\label{group__icub__pf3dTracker_out_data_sec}
None. \hypertarget{group__src__demoYoga_conf_file_sec}{}\doxysubsubsection{\texorpdfstring{Configuration Files}{Configuration Files}}\label{group__src__demoYoga_conf_file_sec}
...
\end{DoxyItemize}\hypertarget{group__src__demoRedBall_commands_sec}{}\doxysubsubsection{\texorpdfstring{Available commands}{Available commands}}\label{group__src__demoRedBall_commands_sec}
...
Note that on the real robot the demo automatically starts.\hypertarget{group__src__demoYoga_tested_os_sec}{}\doxysubsubsection{\texorpdfstring{Tested OS}{Tested OS}}\label{group__src__demoYoga_tested_os_sec}
Windows, Linux
